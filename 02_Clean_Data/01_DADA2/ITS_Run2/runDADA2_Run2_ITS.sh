...
export PROJECTNAME=ITS_Run2
export INPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/Run_2/fastq_files/ITS
export OUTPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run2
export INTERMEDIATEDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run2/intermediate
export RUNPARAMETERS=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run2/.runparams
