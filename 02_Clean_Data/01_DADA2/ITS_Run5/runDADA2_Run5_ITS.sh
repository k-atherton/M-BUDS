...
export PROJECTNAME=ITS_Run5
export INPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/Run_5/fastq_files/ITS
export OUTPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run5
export INTERMEDIATEDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run5/intermediate
export RUNPARAMETERS=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run5/.runparams
