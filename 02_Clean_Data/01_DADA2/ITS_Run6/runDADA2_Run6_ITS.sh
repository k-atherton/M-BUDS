...
export PROJECTNAME=ITS_Run6
export INPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/Run_6/fastq_files/ITS
export OUTPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run6
export INTERMEDIATEDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run6/intermediate
export RUNPARAMETERS=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run6/.runparams
