...
export PROJECTNAME=ST_16S_Run1
export INPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/Run_1/fastq_files/16S
export OUTPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/16S_Run1
export INTERMEDIATEDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/16S_Run1/intermediate
export RUNPARAMETERS=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/16S_Run1/.runparams
