...
export PROJECTNAME=ITS_Run4
export INPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/Run_4/fastq_files/ITS
export OUTPUTDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run4
export INTERMEDIATEDIR=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run4/intermediate
export RUNPARAMETERS=/projectnb/talbot-lab-data/Katies_data/Street_Trees/dada2_output/ITS_Run4/.runparams
