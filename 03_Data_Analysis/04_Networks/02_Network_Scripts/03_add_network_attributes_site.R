...
genera_its <- c(rownames(leaf_its[[1]]), rownames(leaf_its[[2]]), rownames(leaf_its[[3]]), rownames(leaf_its[[4]]), rownames(leaf_its[[5]]), rownames(leaf_its[[6]]), rownames(leaf_its[[7]]), rownames(leaf_its[[8]]), rownames(leaf_its[[9]]))
genera_its <- c(genera_its, rownames(root_its[[1]]), rownames(root_its[[2]]), rownames(root_its[[3]]), rownames(root_its[[5]]), rownames(root_its[[7]]), rownames(root_its[[8]]), rownames(root_its[[9]]), rownames(root_its[[10]]), rownames(root_its[[11]]))
genera_its <- c(genera_its, rownames(m_its[[1]]), rownames(m_its[[2]]), rownames(m_its[[3]]), rownames(m_its[[4]]), rownames(m_its[[5]]), rownames(m_its[[6]]), rownames(m_its[[7]]), rownames(m_its[[8]]), rownames(m_its[[9]]), rownames(m_its[[10]]), rownames(m_its[[11]]), rownames(m_its[[12]]), rownames(m_its[[13]]), rownames(m_its[[14]]))
genera_its <- c(genera_its, rownames(o_its[[1]]), rownames(o_its[[2]]), rownames(o_its[[3]]), rownames(o_its[[4]]), rownames(o_its[[5]]), rownames(o_its[[6]]), rownames(o_its[[7]]), rownames(o_its[[8]]), rownames(o_its[[9]]), rownames(o_its[[10]]), rownames(o_its[[11]]), rownames(o_its[[12]]), rownames(o_its[[13]]), rownames(o_its[[14]]))
genera_its <- unique(genera_its)

genera_16s <- c(rownames(leaf_16s[[1]]), rownames(leaf_16s[[2]]), rownames(leaf_16s[[3]]), rownames(leaf_16s[[4]]), rownames(leaf_16s[[5]]), rownames(leaf_16s[[6]]), rownames(leaf_16s[[7]]), rownames(leaf_16s[[8]]), rownames(leaf_16s[[9]]))
genera_16s <- c(genera_16s, rownames(root_16s[[1]]), rownames(root_16s[[2]]), rownames(root_16s[[3]]), rownames(root_16s[[5]]), rownames(root_16s[[7]]), rownames(root_16s[[8]]), rownames(root_16s[[9]]), rownames(root_16s[[10]]), rownames(root_16s[[11]]))
genera_16s <- c(genera_16s, rownames(m_16s[[1]]), rownames(m_16s[[2]]), rownames(m_16s[[3]]), rownames(m_16s[[4]]), rownames(m_16s[[5]]), rownames(m_16s[[6]]), rownames(m_16s[[7]]), rownames(m_16s[[8]]), rownames(m_16s[[9]]), rownames(m_16s[[10]]), rownames(m_16s[[11]]), rownames(m_16s[[12]]), rownames(m_16s[[13]]), rownames(m_16s[[14]]))
genera_16s <- c(genera_16s, rownames(o_16s[[1]]), rownames(o_16s[[2]]), rownames(o_16s[[3]]), rownames(o_16s[[4]]), rownames(o_16s[[5]]), rownames(o_16s[[6]]), rownames(o_16s[[7]]), rownames(o_16s[[8]]), rownames(o_16s[[9]]), rownames(o_16s[[10]]), rownames(o_16s[[11]]), rownames(o_16s[[12]]), rownames(o_16s[[13]]), rownames(o_16s[[14]]))
...
saveRDS(leaf_network_atts, "/projectnb/talbot-lab-data/Katies_data/Street_Trees/Analysis/Networks/Results/leaf_network_atts.RDS")

root_network_atts <- vector("list", length(root_networks))
root_tax_index <- c(1,2,3,5,7,8,9,10,11)
for(i in 1:length(root_network_atts)){
  j <- root_tax_index[i]
  rownames(root_16s[[j]]) <- gsub(" b__", "b__", rownames(root_16s[[j]]))
  root_network_atts[[i]] <- attributes_cross_genus(root_networks[[i]],
                                                t(root_its[[j]]),
                                                t(root_16s[[j]]),
                                                tax_its[which(tax_its$GENUS %in% colnames(t(root_its[[j]]))),], 
                                                tax_16s[which(tax_16s$Genus %in% colnames(t(root_16s[[j]]))),])
}
