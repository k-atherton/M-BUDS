...
figs4d_osoil <- ggplot(beta_osoil_df_16s,
  ...
  ggtitle("Bacterial community in soil, 0-15 cm") + ylim(c(40,110))

figs4d_osoil
ggsave(paste0("atherton_figures4d_16sbetadisperosoil_", 
              format(Sys.Date(), "%Y%m%d"), ".pdf"), device = cairo_pdf, 
       plot = figs4d_osoil, dpi = 300, width = 6, height = 3.5, units = "in")
