...
figs3e
ggsave(paste0("atherton_figures3e_ITSpcabelowground_", 
              format(Sys.Date(), "%Y%m%d"), ".pdf"), device = cairo_pdf, 
       plot = figs3e, dpi = 300, width = 6, height = 3.5, units = "in")