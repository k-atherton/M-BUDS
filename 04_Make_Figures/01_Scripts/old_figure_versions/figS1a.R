...
figS1a <- ggplot() +
  ...
  scale_color_manual(values = categorical_pal[c(1,4)], guide = "none") + 
  scale_fill_manual(values = categorical_pal[c(1,4)]) + 
  ggtitle("Tree-associated fungal symbionts")

figS1a
ggsave(paste0("atherton_figureS1a_ecmsoil_epiphytesleaves_vs_treetype_boxplot_",
