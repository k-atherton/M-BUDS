...
figs3c
ggsave(paste0("atherton_figures3c_ITSpcabelowground_", 
              format(Sys.Date(), "%Y%m%d"), ".pdf"), device = cairo_pdf, 
       plot = figs3c, dpi = 300, width = 6, height = 3.5, units = "in")
...
figs3d
ggsave(paste0("atherton_figures3d_16Spcabelowground_", 
              format(Sys.Date(), "%Y%m%d"), ".pdf"), device = cairo_pdf, 
