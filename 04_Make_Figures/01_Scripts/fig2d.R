...
func_soil_its <- as.data.frame(metadata_soil_its[,colnames(metadata_soil_its) ==
                                     "perc_animal_pathogen"])
func_soil_16s <- as.data.frame(metadata_soil_16s[,colnames(metadata_soil_16s) ==
                                                   "perc_zoonotic_pathogen"])
func_leaf_its <- as.data.frame(metadata_leaf_its[,colnames(metadata_leaf_its) ==
                                                   "perc_animal_pathogen"])
