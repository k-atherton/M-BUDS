...
length(unique(metadata_osoil_its$tree_id))
...
pca_osoil_df_its$tree_age <- "O"
pca_osoil_df_its$tree_age[which(pca_osoil_df_its$tree_dbh_2021 < 30)] <- "M"
pca_osoil_df_its$tree_age[which(pca_osoil_df_its$tree_dbh_2021 < 10)] <- "Y"

print(adonis2(osoil_aitch_its~pca_osoil_df_its$tree_pit_type))
print(adonis2(osoil_aitch_its~pca_osoil_df_its$tree_age))
print(adonis2(osoil_aitch_its~pca_osoil_df_its$tree_species))

# Plot figure s4a
figs4a_osoil <- ggplot(pca_osoil_df_its, 
...
figs4a_osoil
ggsave(paste0("atherton_figures4a_ITSpcaosoil_", 
              format(Sys.Date(), "%Y%m%d"), ".pdf"), device = cairo_pdf, 
       plot = figs4a_osoil, dpi = 300, width = 6, height = 3.5, units = "in")